...
<div class="language-sh">
  <pre>
    <code>
      <span style="color:var(--vt-c-green);">✔</span><span style="color:#A6ACCD;"> Project name:</span>
...
Import Maps is a relatively new browser
feature. Make sure to use a browser within its [support
range](https://caniuse.com/import-maps). In particular, it is only supported
in Safari 16.4+.
...
<div class="vt-box-container next-steps">
  <Card title="Continue with the Guide" class="next-steps-link card">
    <a class="vt-box" href="/guide/essentials/application.html">
      <p class="next-steps-link"></p>
      <p class="next-steps-caption">
        The guide walks you through every aspect of the framework in full
        detail.
      </p>
    </a>
  </Card>
  <Card title="Try the Tutorial" class="next-steps-link card">
  ...
  <Card title="Check out the Examples" class="next-steps-link card">
