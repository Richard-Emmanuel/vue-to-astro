---
title: Teleport
description: Learn how to use the Teleport component
---
...
<VueSchoolLink
  href="https://vueschool.io/lessons/vue-3-teleport"
  title="Free Vue.js Teleport Lesson"
/>
...
import ModalExample from "./transition-demos/modal.vue";
...
## Deferred Teleport <sup class="vt-badge" data-text="3.5+" />
