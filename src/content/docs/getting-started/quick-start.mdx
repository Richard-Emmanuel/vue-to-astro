...
<div class="vt-box-container next-steps">
  <Card title="Continue with the Guide" class="next-steps-link">
  ...
  <Card title="Try the Tutorial" class="next-steps-link">
  ...
  <Card title="Check out the Examples" class="next-steps-link">
