---
title: Props
description: Learn how to pass data to components using props
---
...
To specify prop validations, you can provide an object with validation requirements to the <span class="options-api">`props` option</span>, instead of an array of strings. For example:
