...
<br />
In addition to the default set of directives shipped in core (like `v-model` or `v-show`),
...
<p v-highlight>
  <mark>This sentence is important! &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</mark>
</p>
...
<br />
When used on components, custom directives will always apply to a component's root
node, similar to [Fallthrough Attributes](/guide/components/attrs).
