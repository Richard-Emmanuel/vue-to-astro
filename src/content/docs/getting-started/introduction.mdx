...
You can learn more about the comparison between the two styles and the potential benefits of Composition API in the [Composition API FAQ](/src/content/ extras-topics/composition-api-faq).
...
<CardGrid>
  ...
  <Card title="Read the Guide" class="next-steps-link card">
